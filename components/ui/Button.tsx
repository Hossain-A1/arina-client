...
export const buttonVariants = cva(
  'eq inline-block whitespace-nowrap rounded-xl border px-4 py-2 text-center text-lg disabled:cursor-default disabled:border-gray disabled:bg-gray disabled:text-black',
  {
    variants: {
      variant: {
        primary:
